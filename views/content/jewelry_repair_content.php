<div id="content"> 
  ...
  <div id="bottom_container">
    <div class="bottom_container bottom_left light">
      <img class="header_img" src="public/images/headers/polishing.png">
      <h2 class="sub_header_left">Cleaning &amp; Polishing</h2>
      <div class="sb_lt_inner_img">
        <img src="public/images/subbox_images/polish.png">
      </div>
    </div>
    <div class="bottom_container bottom_center light">
      <img class="header_img" src="public/images/headers/placement.png">
      <h2 class="sub_header_center">Stone Placement</h2>
      <div class="sb_lt_inner_img">
        <img src="public/images/subbox_images/placement.png">
      </div>
    </div>
    <div class="bottom_container bottom_right light">
      <img class="header_img" src="public/images/headers/sizing.png">
      <h2 class="sub_header_right">Ring Sizing</h2>
      <div class="sb_lt_inner_img">
        <img src="public/images/subbox_images/sizing.png">
      </div>
    </div>
  </div>
</div><!--end content-->